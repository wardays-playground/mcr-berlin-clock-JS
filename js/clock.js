...
function calculateTime(t){ // Calcula la hora actual en formato berlin(?)
    ...
    const minutes = t.getMinutes(); // Minutos actual
    const secondsActual = t.getSeconds(); // segundos actual
    ...
    let actualTime = document.getElementsByClassName('actualTime');
    actualTime[0].innerHTML = `${hour} : ${minutes} : ${secondsActual}`;
}
...
function printTime(){
    ...
    let rowHours5 = document.getElementsByClassName('cell hour5');
    let rowHours1 = document.getElementsByClassName('cell hour1');
    let rowMinutes5 = document.getElementsByClassName('cell minute5');
    let rowMinutes1 = document.getElementsByClassName('cell minute1');
...
setInterval('this.getActualTime()', 1000); // Indicamos que haga getActualTime() cada segundo